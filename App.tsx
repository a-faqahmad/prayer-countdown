...
const styles = StyleSheet.create({
  ...
  markNorth: {top: 10, left: '50%', marginLeft: -6},
  markEast: {right: 10, top: '50%', marginTop: -10},
  markSouth: {bottom: 10, left: '50%', marginLeft: -6},
  markWest: {left: 10, top: '50%', marginTop: -10},
  qiblaArrowContainer: {
    position: 'absolute',
    width: 220,
    height: 220,
